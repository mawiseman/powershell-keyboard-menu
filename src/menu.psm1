...
# . .\menu.ps1
# Invoke-ShowMenu requieres 2 Parameters:
...
# For example:
# Invoke-ShowMenu "Choose your favorite Band - Un-ordered" @{"sl"="Slayer";"me"="Metallica";"ex"="Exodus";"an"="Anthrax"}
# Invoke-ShowMenu "Choose your favorite Band - Ordered" ([ordered]@{"sl"="Slayer";"me"="Metallica";"ex"="Exodus";"an"="Anthrax"})
# #############################################################################

function Invoke-ShowMenu() {
	[CmdLetBinding()]
	param (
...
Export-ModuleMember Invoke-ShowMenu